package com.GingkoTreeX.rechest;

import com.GingkoTreeX.rechest.Controller.Command.CommandManagerA;
import com.GingkoTreeX.rechest.Controller.Command.CommandManagerB;
import com.GingkoTreeX.rechest.Controller.Config.ConfigManager;
import com.GingkoTreeX.rechest.Entity.RefreshItem;
import com.GingkoTreeX.rechest.Listener.ItemInfoListener;
import com.GingkoTreeX.rechest.Utils.ItemStackUtil;
...
public class REChest extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        // 注册指令
        getCommand("addrefreshitem").setExecutor(new CommandManagerB(this));
        getCommand("cleantime").setExecutor(new CommandManagerB(this));
